	...
	tests := []struct {
	...
	}{
		{
			...
			expecting: Step{
				...
				ReasonCells:       rowPeers(board.Coordinates{Row: 4, Col: 4}).Slice(),
		...
		},
		{
			...
			expecting: Step{
				...
				ReasonCells:       colPeers(board.Coordinates{Row: 3, Col: 3}).Slice(),
		...
		},
		{
			...
			expecting: Step{
				...
				AffectedCells:     []board.Coordinates{{Row: 4, Col: 4}},
				ReasonCells:       boxPeers(board.Coordinates{Row: 4, Col: 4}).Slice(),
				RemovedCandidates: 0b0000100000,
				PlacedValue:       ptr.To(5),
			},
		},
		...
		},
		{
			...
			expecting: Step{
				...
				ReasonCells:       allPeers(board.Coordinates{Row: 6, Col: 2}).Slice(),
		...
		},
		{
			...
			expecting: Step{
				...
				ReasonCells:       allPeers(board.Coordinates{Row: 3, Col: 7}, board.Coordinates{Row: 3, Col: 8}).Slice(),
